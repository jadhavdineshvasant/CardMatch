    ...
    public class EventDispatcher : MonoBehaviour
    {
        ...
        public void UnsubscribeAll(MonoBehaviour subscriber)
        {
            ...
            foreach (var key in eventListeners.Keys)
            {
                ...
                var toRemove = eventListeners[key].FindAll(listener => (UnityEngine.Object)listener.Target == subscriber);
            ...
            {
                eventListeners[key].RemoveAll(listener => (UnityEngine.Object)listener.Target == subscriber);
